...
namespace Automation.Domain.Classes.HL7
{
    public class SearchCriteria
    {
        ...
        {
            get { return elements[0].Repetition; }
            set
            {
                elements[0] = new SearchCriteriaElement(
                    elements[0].Position,
        ...
        public SearchCriteriaElement Field
        {
            get { return elements[1]; }
            set { elements[1] = value; }
        }

        public SearchCriteriaElement Component
        {
            get { return elements[2]; }
            set { elements[2] = value; }
        }

        public SearchCriteriaElement Subcomponent
        {
        ...
        public static implicit operator SearchCriteria(string criteria)
        {
